...
coverage or non-material wording imperfections may be recorded as safe incompleteness only when they
cannot change source support, grading, closure, or completion.

For Critical Thinking, real use means the complete journey: auth/profile, adoption/activation,
Lesson and every required Activity, wrong-to-correct paths for all families, known/clear/restoration,
Support open/refresh/hide/restore and referenced grading, every Leg Guardian and the Expedition
Guardian, recovery/retreat/resume/rematch/first-win rewards, leaderboard, refresh/sign-in persistence,
and a second learner's isolation.
