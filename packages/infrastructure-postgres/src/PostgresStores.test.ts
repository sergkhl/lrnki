    ...
    const layer: DerivedGraphLayer = {
      ...
      derivedNodes: [
        ...
        { nodeKind: "enrichment", derivedNodeId: coreId, groundingOrigin: "llm_grounded", role: "synthetic_primary", layer: "derived", canonicalLabel: "Photosynthesis", normalizedLabel: "photosynthesis", declaredDomain: "biology", aliases: [],
          groundingBundle: { groundingOrigin: "llm_grounded", definitions: [{ passageType: "definition", text: "Photosynthesis converts light to chemical energy.", groundingOrigin: "llm_grounded", headingPath: [], locator: {}, verbatimCheck: { disposition: "not_applicable_by_grounding", rationale: "generated" } }], mentions: [], groundingAnchorReferences: [], generatingModel: "mock-gen", rationale: "topic concept" } },
        { nodeKind: "enrichment", derivedNodeId: secondId, groundingOrigin: "llm_grounded", role: "synthetic_primary", layer: "derived", canonicalLabel: "Chloroplast", normalizedLabel: "chloroplast", declaredDomain: "biology", aliases: ["chloroplasts"],
          groundingBundle: { groundingOrigin: "llm_grounded", definitions: [{ passageType: "definition", text: "A chloroplast is the organelle where photosynthesis occurs.", groundingOrigin: "llm_grounded", headingPath: [], locator: {}, verbatimCheck: { disposition: "not_applicable_by_grounding", rationale: "generated" } }], mentions: [], groundingAnchorReferences: [], generatingModel: "mock-gen", rationale: "topic concept" } }
      ],
      prerequisiteEdges: [
