...
// studyItem's answer-key by the cross-family judge, producing one `graded` row and
// recording the judge model as the grader identity. The judge proposes; this
// deterministic transform maps its verdict into an immutable append — the only thing
// tests assert (AGENTS rule 11).
