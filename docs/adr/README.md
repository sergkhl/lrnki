...
Decision scope and retention rules live in [AGENTS.md](../../AGENTS.md#documentation-workflow).
...
- [0026 — Shared acquisition identity](./0026-typed-study-item-bank.md)
- [0032 — Mastery-aligned Learner App game UX](./0032-keep-learner-app-in-flow-through-mastery-aligned-game-ux.md)
- [0033 — Theme vocabulary independent of content identity](./0033-plain-identifiers-single-themed-vocabulary-mapping.md)
