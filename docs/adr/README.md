...
- [0019 — Graph Enrichment and the Derived Graph Layer](./0019-graph-enrichment-derived-layer.md)
...
- [0030 — Confidence-gated synthesis with web-grounding fallback](./0030-confidence-gated-synthesis-with-web-grounding.md) (probe half Accepted; web-grounding fallback Proposed)
