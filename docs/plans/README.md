...
1. [2026-08-24-001 — Test a Same-Call Grounding Identity-Scope Audit](./2026-08-24-001-test-grounding-identity-scope-audit.md)
   ...
   mechanism, excluding established PFOR/ferredoxin oxidation. Do not rerun it; the completed
   source-backed diagnostic leaves all new assignment or learner-asset policy work owner-gated in
