...
- [Re-author three-Leg Expeditions from online research](./2026-09-01-research-authored-three-leg-expeditions.md)
  — **In progress in Unit 7; priority 1.** Critical Thinking revision `dc27a643…e55b43`,
  ...
  `07bd08f8…40feca3` passed complete learner/private-source review. Land the five exact candidates in
  the atomic no-model cutover.
